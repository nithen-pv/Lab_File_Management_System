...
<body>
    <?php include $_SERVER['DOCUMENT_ROOT'] . '/MES/admin/Dashboard/edit_student.php'; ?>
    <nav class="navbar navbar-dark sticky-top bg-dark flex-md-nowrap p-0 shadow">
        ...
        <form class="input-group" action="coordinator_studs.php?b_id=<?php echo $_GET['b_id']; ?>&c_name=<?php echo $_GET['c_name']; ?>" method="post">
        ...
        <div class="row">
            ...
            <main role="main" class="col-md-9 ml-sm-auto col-lg-10 px-md-4 main-box-size">
                <div class="d-flex justify-content-between flex-wrap flex-md-nowrap align-items-center pt-3 pb-2 mb-3 border-bottom">
                    <?php if ($search) {
                    ?>
                        <a href="coordinator_studs.php?b_id=<?php echo $_GET['b_id']; ?>&c_name=<?php echo $_GET['c_name']; ?>" class="h5"><i class="fas fa-arrow-left"></i> Back</a>
                    <?php
                    } else {
                    ?>
                    ...
                    <div class="btn-toolbar mb-2 mb-md-0">
                        ...
                        <span class="fw-normal ml-1 mt-1"> <?php echo $_GET["c_name"]; ?> </span>
                    </div>
