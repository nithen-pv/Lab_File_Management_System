...
<body>
  ...
  if (isset($_POST['coordinator_name'])) {
    ...
    $sql = "INSERT INTO Coordinators (Name, username, password, batch)
    VALUES ('$coord_name','$coord_username','$coord_password','$coord_batch')";
  ...
  include $_SERVER['DOCUMENT_ROOT'] . '/MES/admin/Dashboard/edit_coordinator.php';
  ?>
  <nav class="navbar navbar-dark sticky-top bg-dark flex-md-nowrap p-0 shadow">
    ...
    <form class="input-group" action="coordinators.php" method="post">
    ...
    <div class="row">
      <nav id="sidebarMenu" class="col-md-3 col-lg-2 d-md-block bg-dark sidebar collapse mt-4">
        <div class="sidebar-sticky pt-3">
          <ul class="nav flex-column">
            ...
            <li class="nav-item">
              <a class="nav-link navElement" href="coordinators.php">
      ...
      <main role="main" class="col-md-9 ml-sm-auto col-lg-10 px-md-4 main-box-size">
        <div class="d-flex justify-content-between flex-wrap flex-md-nowrap align-items-center pt-3 pb-2 mb-3 border-bottom"> <?php if ($search) {
                                                                                                                              ?>
            <a href="coordinators.php" class="h5"><i class="fas fa-arrow-left"></i> Back</a>
          <?php
                                                                                                                              } else {
          ?>
            <h1 class="h2"><i class="fas fa-chalkboard-teacher"></i> Coordinators</h1>
          <?php
                                                                                                                              } ?>
          <div class="btn-toolbar mb-2 mb-md-0">
            <button type="button" class="btn btn-sm btn-primary" data-bs-toggle="modal" data-bs-target="#CoordinatorModal"><i class="fas fa-user-plus"></i> Add Coordinator</button>
          </div>
        </div>
          ...
          <div class="modal-dialog">
            <div class="modal-content">
              <div class="modal-header">
                <h5 class="modal-title" id="exampleModalLabel"><i class="fas fa-chalkboard-teacher"></i> Add Coordinator</h5>
              ...
              <form action="" method="POST">
                <div class="modal-body">
                  <div class="form-group">
                    <label for=""></label>
                    <small id="helpId" class="form-text text-muted">Coordinator Name</small>
        ...
        <div class="modal fade" id="coordinator_edit_modal" tabindex="-1" aria-labelledby="exampleModalLabel" aria-hidden="true">
          <div class="modal-dialog">
            <div class="modal-content">
              <div class="modal-header">
                <h5 class="modal-title" id="exampleModalLabel">Edit Coordinator Details</h5>
                <button type="button" class="btn-close" data-bs-dismiss="modal" aria-label="Close"></button>
              </div>
              <form action="" method="POST">
                <div class="modal-body">
                  <div class="form-group">
                    <input type="hidden" class="form-control" name="coordinator_id" id="coordinator_id" aria-describedby="helpId" placeholder="" value=''>
        ...
        <?php
        include $_SERVER['DOCUMENT_ROOT'] . '/MES/mysql_conn/mysql_conn.php';
        $sql = "SELECT * FROM Coordinators wHERE Name LIKE '%$search%' ";
        $result = $conn->query($sql);
        ...
        ?>
          <div class="table-responsive" style="border-radius: 7px; box-shadow: 0 1px 10px #ccc;">
            <table class="table table-light table-sm table-hover" style="margin-bottom: 0;">
              ...
              <tbody>
                ...
                ?>
                  ...
                  <tr>
                    ...
                    <td><a href="coordinator_studs.php?b_id=<?php echo $row["batch"]; ?>&c_name=<?php echo $row["Name"]; ?>"> <?php echo $row["Name"]; ?> </a> </td>
                    <td>
                      <?php
                      $batch_id = $row["batch"];
                    ...
                    <td>
                      ...
                      <a href="delete_coordinator.php?delete=<?php echo $row['id']; ?>" class="del_user">
              ...
              ?>
                <div class="col-md-6 mx-auto">
                  <h2 style="margin-left: 120px;">Add Coordinators</h2>
  ...
  <script>
    function edit(id, name, batch, username, password) {
      console.log(id);
      console.log(name);
      console.log(batch);
