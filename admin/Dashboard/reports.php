...
<body style="background: #eee;">
    ...
    <div class="container-fluid">
        <div class="row">
            <nav id="sidebarMenu" class="col-md-3 col-lg-2 d-md-block sidebar bg-dark collapse mt-4">
                <div class="sidebar-sticky pt-3">
                    <ul class="nav flex-column">
                        <li class="nav-item">
                            <a class="nav-link navElement" href="reports.php">
                        ...
                        <div class="col-4">
                            <a href="dashboard.php" style="text-decoration: none;">
                                <div class="p-4 border bg-warning dashboard_element" style="border-radius:15px;text-align:center">
                                    <i class="fas fa-user-graduate fa-7x" style="color: white;"></i>
                                    <?php
                        ...
                        <div class="col-4">
                            <a href="files.php" style="text-decoration: none;">
                                <div class="p-4 border bg-secondary dashboard_element" style="border-radius:15px;text-align:center">
                                    <i class="fas fa-server fa-7x" style="color: white;"></i>
                                    <?php
                                    $sql = "SELECT SUM(file_size) AS value_sum FROM files";
                                    $result = $conn->query($sql);
                                    $row = $result->fetch_assoc();
                                    $sum = $row['value_sum'];
                                    ?>
                                    <br>
                                    <span style="color: white;font-size:1.6rem"><?php echo round($sum * 0.000001); ?>MB Storage Used </span>
                                </div>
                            </a>
                        </div>
                        <div class="col-4 mt-4">
                            <a href="coordinators.php" style="text-decoration: none;">
                                <div class="p-4 border bg-danger dashboard_element" style="border-radius:15px;text-align:center; ">
                                    ...
                                    ?>
                                    <br>
                                    <span style="color: white;font-size:1.6rem"><?php echo $rows_count_value; ?> Coordinators</span>
                                </div>
                            </a>
                        </div>
                        <div class="col-4 mt-4">
                            <a href="batch.php" style="text-decoration: none;">
                                <div class="p-4 border bg-success dashboard_element" style="border-radius:15px;text-align:center; ">
                                    <i class="fas fa-project-diagram fa-7x" style="color: white;"></i>
                                    <?php
                                    ...
                                    ?>
                                    <br>
                                    <span style="color: white;font-size:1.6rem"><?php echo $rows_count_value; ?> Batch </span>
                                </div>
                            </a>
                        </div>
                        <div class="col-4 mt-4">
                            <a href="teachers.php" style="text-decoration: none;">
                                <div class="p-4 border bg-primary dashboard_element" style="border-radius:15px;text-align:center; ">
