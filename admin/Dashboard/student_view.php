...
<body>
  <nav class="navbar navbar-dark sticky-top bg-dark flex-md-nowrap p-0 shadow">
    ...
    <form class="input-group" action="student_view.php?id=<?php echo $_GET["id"]; ?>&b_id=<?php echo $_GET['b_id'] ?>&batch=<?php echo $_GET['batch'] ?>" method="POST">
    ...
    <div class="row">
      ...
      <main role="main" class="col-md-9 ml-sm-auto col-lg-10 px-md-4 main-box-size">
        <div class="d-flex justify-content-between flex-wrap flex-md-nowrap align-items-center pt-3 pb-2 mb-3 border-bottom">
          <a href="batch_view.php?id=<?php echo $_GET['b_id'] ?>&batch=<?php echo $_GET['batch'] ?>" class="h5"><i class="fas fa-arrow-left"></i> Back</a>
        </div>
        ...
        include $_SERVER['DOCUMENT_ROOT'] . '/MES/mysql_conn/mysql_conn.php';
        $id = $_GET["id"];
        $sql = "SELECT * FROM files wHERE student_id='$id' AND filename LIKE '%$search%'";
