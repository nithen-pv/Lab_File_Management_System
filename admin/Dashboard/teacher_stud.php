...
<body>
    <nav class="navbar navbar-dark sticky-top bg-dark flex-md-nowrap p-0 shadow">
        ...
        <form class="input-group" action="teacher_stud.php?b_id=<?php echo $_GET['b_id'] ?>&start=<?php echo $_GET['start'] ?>&stop=<?php echo $_GET['stop'] ?>&t_name=<?php echo $_GET["t_name"]; ?>" method="post">
        ...
        <div class="row">
            ...
            <main role="main" class="col-md-9 ml-sm-auto col-lg-10 px-md-4 main-box-size">
                <div class="d-flex justify-content-between flex-wrap flex-md-nowrap align-items-center pt-3 pb-2 mb-3 border-bottom">
                    <?php if ($search) {
                    ?>
                        <a href="teacher_stud.php?b_id=<?php echo $_GET['b_id'] ?>&start=<?php echo $_GET['start'] ?>&stop=<?php echo $_GET['stop'] ?>&t_name=<?php echo $_GET["t_name"]; ?>" class="h5"><i class="fas fa-arrow-left"></i> Back</a>
                    <?php
                    } else {
                    ?>
                    ...
                    <div class="btn-toolbar mb-2 mb-md-0">
                        ...
                        <span class="fw-normal ml-1 mt-1"> <?php echo $_GET["t_name"]; ?> </span>
                    </div>
                </div>
                ...
                $start = $_GET["start"];
                $stop = $_GET["stop"];
                $sql = "SELECT * FROM Student WHERE Batch='$batch' AND RollNo >= '$start' AND RollNo <= '$stop' AND Student_Name LIKE '%$search%'";
