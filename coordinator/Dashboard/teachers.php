...
<body>
  ...
  include $_SERVER['DOCUMENT_ROOT'] . '/MES/coordinator/Dashboard/edit_teacher.php';
  ?>
      ...
      <nav id="sidebarMenu" class="col-md-3 col-lg-2 d-md-block bg-dark sidebar collapse mt-4">
        <div class="sidebar-sticky pt-3">
          <ul class="nav flex-column">
            ...
            <li class="nav-item">
              <a class="nav-link navElement" href="teachers.php" id="teacher">
      ...
      <main role="main" class="col-md-9 ml-sm-auto col-lg-10 px-md-4 main-box-size">
        <div class="d-flex justify-content-between flex-wrap flex-md-nowrap align-items-center pt-3 pb-2 mb-3 border-bottom">
          ...
          <div class="btn-toolbar mb-2 mb-md-0">
            <button type="button" class="btn btn-sm btn-primary me-2" data-bs-toggle="modal" data-bs-target="#CoordinatorModal"><i class="fas fa-user-plus"></i> Add Teachers</button>
          ...
          <div class="modal-dialog">
            <div class="modal-content">
              <div class="modal-header">
                <h5 class="modal-title" id="exampleModalLabel"><i class="fas fa-chalkboard-teacher"></i> Add Teacher</h5>
                ...
                <div class="modal-body">
                  <div class="form-group">
                    ...
                    ?>
                      ...
                      ?>
                        <span class="input-group-text"><?php echo $row['batch_name']; ?> <?php echo $row['course']; ?> <?php echo $row['year']; ?> </span>
                      <?php
                      }
                      ?>
                    <?php
        ...
        $sql = "SELECT * FROM Teachers wHERE Name LIKE '%$search%' AND batch='$batch'";
        $result = $conn->query($sql);
              ...
              <tbody>
                ...
                ?>
                  ...
                  <tr>
                    ...
                    <td style="color:dodgerblue"><?php echo $row["name"]; ?></td>
                    <td>
                      <?php
                      $batch_id = $row["batch"];;
                    ...
                    <td>
                      ...
                      <button type="button" class="btn btn-sm" name='update' data-bs-toggle="modal" data-bs-target="#coordinator_edit_modal" onclick='edit(<?php echo $row["id"]; ?>,"<?php echo $row["name"]; ?>","<?php echo $row["username"]; ?>","<?php echo $row["password"]; ?>"
                      ,<?php echo $row["start"]; ?>,<?php echo $row["stop"]; ?>)'>
                        <i class="fas fa-edit" style="color:dodgerblue"></i>
                      </button>
                      <a href="delete_teacher.php?delete=<?php echo $row['id']; ?>" class="del_teacher">
  ...
  <script>
    function edit(id, name, username, password, start, stop) {
    ...
    $('.del_teacher').on('click', function(e) {
      e.preventDefault();
