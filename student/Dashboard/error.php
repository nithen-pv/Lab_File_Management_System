...
if (!$_SESSION["username"]) {
    header('Location: http://localhost/MES/student/');
}
?>
            ...
            <main role="main" class="col-md-9 ml-sm-auto col-lg-10 px-md-4 main-box-size">
                ...
                <div class="d-flex justify-content-between flex-wrap flex-md-nowrap align-items-center pt-3 pb-2 mb-3 border-bottom">
                    ...
                    <div class="btn-toolbar mb-2 mb-md-0">
                        ...
                        <span class="fw-normal ml-1 mt-1"> <?php echo $_SESSION["stud_name"]; ?> </span>
                    </div>
                </div>
                <div class="col-md-6 mx-auto">
                    <h2 style="margin-left: 50px;">Sorry, file already exists.Your file was not uploaded.</h2>
